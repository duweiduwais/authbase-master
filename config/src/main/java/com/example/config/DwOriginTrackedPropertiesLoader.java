...
class DwOriginTrackedPropertiesLoader {
    private final Resource resource;

    DwOriginTrackedPropertiesLoader(Resource resource) {
    ...
    public Map<String, OriginTrackedValue> load(boolean expandLists) throws IOException {
        DwOriginTrackedPropertiesLoader.CharacterReader reader = new DwOriginTrackedPropertiesLoader.CharacterReader(this.resource);
        Throwable var3 = null;
        ...
        try {
            ...
            LinkedHashMap var18 = Maps.newLinkedHashMap(result);
            return var18;
    ...
    private String loadKey(StringBuilder buffer, DwOriginTrackedPropertiesLoader.CharacterReader reader) throws IOException {
        buffer.setLength(0);
    ...
    private OriginTrackedValue loadValue(StringBuilder buffer, DwOriginTrackedPropertiesLoader.CharacterReader reader, boolean splitLists) throws IOException {
        buffer.setLength(0);
